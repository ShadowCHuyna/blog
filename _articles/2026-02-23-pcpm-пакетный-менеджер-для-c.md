---
title: pcpm - пакетный менеджер для C
date: 2026-02-23T20:32:00.000+10:00
last_modified_at: 2026-02-23T20:32:00.000+10:00
author: Sch
authors: ["Sch"]
description: пакетный менеджер для C библиотек на python. Скачивает библиотеки
  генерирует код.
layout: article
tags: [c, package-manager, python, programming]
---
...
[список доступных пакетов](https://github.com/ShadowCHuyna/pcpm-packages)

[github](https://github.com/ShadowCHuyna/pcpm)
...
```json
{
    ...
    "mirrors": [
        "http://pcpmirror.potatom.net/packages",
        "/example/path"
    ],
    "origin": "./libs",
